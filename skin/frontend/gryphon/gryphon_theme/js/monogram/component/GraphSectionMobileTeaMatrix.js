goog.provide('monogram.component.GraphSectionMobileTeaMatrix');
 ...
 */
monogram.component.GraphSectionMobileTeaMatrix = function(options, element) {
  goog.events.EventTarget.call(this);
  this.options = $j.extend({}, monogram.component.GraphSectionMobileTeaMatrix.DEFAULT, options);
  this.element = element;

  console.log('monogram.component.GraphSectionMobileTeaMatrix');
...
goog.inherits(monogram.component.GraphSectionMobileTeaMatrix, goog.events.EventTarget);
 ...
 * @const {object}
 */
monogram.component.GraphSectionMobileTeaMatrix.DEFAULT = {
  'option_01': '',
  'option_02': ''
};
 ...
 * @type {string}
 */
monogram.component.GraphSectionMobileTeaMatrix.ON_GRAPH_SECTION_READY = 'on_graph_section_ready';
 ...
 * @type {string}
 */
monogram.component.GraphSectionMobileTeaMatrix.EVENT_02 = '';
...
monogram.component.GraphSectionMobileTeaMatrix.prototype.create_data_array = function(){
  ...
  for (var i = 0, l=this.main_array.length; i < l; i++) {
    ...
    if (goog.isDefAndNotNull(data_item.data_pair_array) == false || data_item.data_pair_array.length == 0) {
      console.log('ERROR: monogram.component.GraphSectionMobileTeaMatrix: sub_id_array not declared');
    }
...
monogram.component.GraphSectionMobileTeaMatrix.prototype.create_mouse = function() {
...
monogram.component.GraphSectionMobileTeaMatrix.prototype.create_graph = function(){
...
monogram.component.GraphSectionMobileTeaMatrix.prototype.private_method_01 = function() {};
monogram.component.GraphSectionMobileTeaMatrix.prototype.private_method_02 = function() {};
monogram.component.GraphSectionMobileTeaMatrix.prototype.private_method_03 = function() {};
monogram.component.GraphSectionMobileTeaMatrix.prototype.private_method_04 = function() {};
monogram.component.GraphSectionMobileTeaMatrix.prototype.private_method_05 = function() {};
monogram.component.GraphSectionMobileTeaMatrix.prototype.private_method_06 = function() {};


/**
 * sample_method_calls
 */
monogram.component.GraphSectionMobileTeaMatrix.prototype.sample_method_calls = function() {
  monogram.component.GraphSectionMobileTeaMatrix.superClass_.method_02.call(this);                                    // call is important
  this.dispatchEvent(new goog.events.Event(monogram.component.GraphSectionMobileTeaMatrix.EVENT_01));
};
...
monogram.component.GraphSectionMobileTeaMatrix.prototype.public_method_01 = function() {};
monogram.component.GraphSectionMobileTeaMatrix.prototype.public_method_02 = function() {};
monogram.component.GraphSectionMobileTeaMatrix.prototype.public_method_03 = function() {};
monogram.component.GraphSectionMobileTeaMatrix.prototype.public_method_04 = function() {};
monogram.component.GraphSectionMobileTeaMatrix.prototype.public_method_05 = function() {};
monogram.component.GraphSectionMobileTeaMatrix.prototype.public_method_06 = function() {};


monogram.component.GraphSectionMobileTeaMatrix.prototype.enable_graph = function(){
  this.is_enabled = true;
};

monogram.component.GraphSectionMobileTeaMatrix.prototype.disable_graph = function(){
  this.is_enabled = false;
};
...
monogram.component.GraphSectionMobileTeaMatrix.prototype.display_combination = function(main_str, child_str) {
 ...
 */
monogram.component.GraphSectionMobileTeaMatrix.prototype.display_combination_index = function(main_index_param, child_index_param) {
...
monogram.component.GraphSectionMobileTeaMatrix.prototype.delayed_display_combination_index = function() {
 ...
 * @param  {object} event
 */
monogram.component.GraphSectionMobileTeaMatrix.prototype.on_combined_data_loader_load_complete = function(event) {
  ...
  this.dispatchEvent(new goog.events.Event(monogram.component.GraphSectionMobileTeaMatrix.ON_GRAPH_SECTION_READY));
 ...
 * @param  {object} event
 */
monogram.component.GraphSectionMobileTeaMatrix.prototype.on_event_handler_02 = function(event) {
};
 ...
 * @param  {object} event
 */
monogram.component.GraphSectionMobileTeaMatrix.prototype.on_event_handler_03 = function(event) {
};
 ...
 * @param  {object} event
 */
monogram.component.GraphSectionMobileTeaMatrix.prototype.on_event_handler_04 = function(event) {
};
...
monogram.component.GraphSectionMobileTeaMatrix.prototype.goto_next_main = function() {
...
monogram.component.GraphSectionMobileTeaMatrix.prototype.goto_prev_main = function() {
  if(this.is_enabled == true){
    var target_main_index = this.main_index - 1;
...
monogram.component.GraphSectionMobileTeaMatrix.prototype.goto_next_sub = function() {
  if(this.is_enabled == true){
...
monogram.component.GraphSectionMobileTeaMatrix.prototype.goto_prev_sub = function() {
  if(this.is_enabled == true){
    var target_sub_index = this.sub_index - 1;
 ...
 */
monogram.component.GraphSectionMobileTeaMatrix.prototype.is_child_of_main = function(main_str, child_str) {
 ...
 * @return {Boolean}       [description]
 */
monogram.component.GraphSectionMobileTeaMatrix.prototype.get_index_of_main_str = function(main_str){
 ...
 * @return {Boolean}       [description]
 */
monogram.component.GraphSectionMobileTeaMatrix.prototype.get_index_of_child_str = function(child_str, main_index_param){
...
monogram.component.GraphSectionMobileTeaMatrix.prototype.hexToRgb = function (hex) {
