goog.provide('monogram.component.CombinationGraphItem04');
 ...
 */
monogram.component.CombinationGraphItem04 = function(options, paper) {

  goog.events.EventTarget.call(this);
  this.options = $j.extend({}, monogram.component.CombinationGraphItem04.DEFAULT, options);
  this.paper = paper;
  ...
  this.cached_target_x = 0;
  this.cached_target_y = 0;
  this.cached_decorative_x = 0;
  this.cached_decorative_y = 0;
  // this.cached_first_target_x = 0;
  // this.cached_first_target_y = 0;
  // this.cached_first_decorative_x = 0;
  // this.cached_first_decorative_y = 0;
...
goog.inherits(monogram.component.CombinationGraphItem04, goog.events.EventTarget);
 ...
 * @const {object}
 */
monogram.component.CombinationGraphItem04.DEFAULT = {
  'fill_color': '#b3c5cd',
  'scale_factor': 1,
  'is_mobile': false
};
 ...
 * @type {string}
 */
monogram.component.CombinationGraphItem04.EVENT_01 = '';
 ...
 * @type {string}
 */
monogram.component.CombinationGraphItem04.EVENT_02 = '';
...
monogram.component.CombinationGraphItem04.prototype.update_layout = function() {
  ...
  */
  ...
  for (var i = 1, l=this.displayed_data_x.length; i < l; i++) {
    ...
    this.cached_target_x = (this.displayed_data_x[i] * this.displayed_data_percent[i].x) + 
               (this.displayed_circle_x[i] * (1-this.displayed_data_percent[i].x)) +
                this.original_center_x;

    this.cached_target_y = (this.displayed_data_y[i] * this.displayed_data_percent[i].y) + 
               (this.displayed_circle_y[i] * (1-this.displayed_data_percent[i].y)) + 
                this.original_center_y;

    this.cached_decorative_x = (this.new_decorative_x[i] * this.displayed_data_percent[i].x) + 
                   (this.new_decorative_circle_x[i] * (1-this.displayed_data_percent[i].x)) + 
                    this.original_center_x;

    this.cached_first_decorative_y = (this.new_decorative_y[i] * this.displayed_data_percent[i].y) + 
    ...
    this.path_array.push(
      this.cached_target_x, 
      this.cached_target_y
    );
    
    this.path_array.push(
      this.cached_decorative_x, 
      this.cached_first_decorative_y
    );
...
monogram.component.CombinationGraphItem04.prototype.private_method_02 = function() {};
monogram.component.CombinationGraphItem04.prototype.private_method_03 = function() {};
monogram.component.CombinationGraphItem04.prototype.private_method_04 = function() {};
monogram.component.CombinationGraphItem04.prototype.private_method_05 = function() {};
monogram.component.CombinationGraphItem04.prototype.private_method_06 = function() {};


/**
 * sample_method_calls
 */
monogram.component.CombinationGraphItem04.prototype.sample_method_calls = function() {
  monogram.component.CombinationGraphItem04.superClass_.method_02.call(this);                                    // call is important
  this.dispatchEvent(new goog.events.Event(monogram.component.CombinationGraphItem04.EVENT_01));
};
 ...
 */
monogram.component.CombinationGraphItem04.prototype.set_score = function(score_param) {
  ...
  for (var i = 0, l=this.score_array.length; i < l; i++) {
    ...
    */
    ...
    target_x = (Math.cos(graph_angle) * ((this.score_array[i]) * 20 * this.scale_factor));// + this.original_center_x;
    target_y = (Math.sin(graph_angle) * ((this.score_array[i]) * 20 * this.scale_factor));// + this.original_center_y;

    circle_x = (Math.cos(graph_angle) * (2 * 20 * this.scale_factor));
    circle_y = (Math.sin(graph_angle) * (2 * 20 * this.scale_factor));
  ...
  for (var i = 0, l=this.displayed_data_x.length; i < l; i++) {
    ...
    var mid_x = (Math.cos(graph_mid_angle) * decorative_score * 20 * this.scale_factor);// + this.original_center_x;
    var mid_y = (Math.sin(graph_mid_angle) * decorative_score * 20 * this.scale_factor);// + this.original_center_y;

    this.new_decorative_x[i] = mid_x;
    this.new_decorative_y[i] = mid_y;


    this.new_decorative_circle_x[i] = (Math.cos(graph_mid_angle) * 2 * 20 * this.scale_factor);
    this.new_decorative_circle_y[i] = (Math.sin(graph_mid_angle) * 2 * 20 * this.scale_factor);
 ...
 */
monogram.component.CombinationGraphItem04.prototype.set_fill_color = function(color_param) {          // this doesn't work..
 ...
 */
monogram.component.CombinationGraphItem04.prototype.animate_in = function(delay_param) {
  // this.update_layout();
...
monogram.component.CombinationGraphItem04.prototype.animate_out = function(delay_param) {
...
monogram.component.CombinationGraphItem04.prototype.instant_show = function() {
  if(this.is_visible == false){
    this.is_visible = true;
    for (var i = 0, l=this.displayed_data_percent.length; i < l; i++) {
...
monogram.component.CombinationGraphItem04.prototype.instant_hide = function() {
  if(this.is_visible == true){
    this.is_visible = false;
...
monogram.component.CombinationGraphItem04.prototype.bounce = function(delay_param){
...
monogram.component.CombinationGraphItem04.prototype.on_animate_update = function() {
  this.update_layout();
};
 ...
 * @param  {object} event
 */
monogram.component.CombinationGraphItem04.prototype.on_event_handler_02 = function(event) {
};
 ...
 * @param  {object} event
 */
monogram.component.CombinationGraphItem04.prototype.on_event_handler_03 = function(event) {
};
 ...
 * @param  {object} event
 */
monogram.component.CombinationGraphItem04.prototype.on_event_handler_04 = function(event) {
};
