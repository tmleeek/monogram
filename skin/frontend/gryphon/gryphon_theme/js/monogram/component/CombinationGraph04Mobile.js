goog.provide('monogram.component.CombinationGraph04Mobile');
...
goog.require('monogram.component.CombinationGraphItem04Mobile');
 ...
 */
monogram.component.CombinationGraph04Mobile = function(options, element) {
  
  goog.events.EventTarget.call(this);
  this.options = $j.extend({}, monogram.component.CombinationGraph04Mobile.DEFAULT, options);
  this.element = element;


  this.svg_element = this.element.find('#combination-graph-svg');

  this.scale_factor = 0.6333;
  ...
  this.original_center_y = 300;
  this.original_width = 600;
  this.original_height = 600;


  /**
   * @type {monogram.component.CombinationGraphItem04Mobile}
   */
  this.graph_01 = null;
  ...
  this.graph_01 = new monogram.component.CombinationGraphItem04Mobile({
    //'fill_color': '#b3c5cd'
  }, this.paper);
  this.graph_01.i = 0;
  ...
  this.graph_01b = new monogram.component.CombinationGraphItem04Mobile({
    //'fill_color': '#b3c5cd'
  }, this.paper);
  this.graph_01b.i = 0;
  ...
  this.graph_02 = new monogram.component.CombinationGraphItem04Mobile({
    //'fill_color': '#bcc197'
  }, this.paper);
  ...
  this.graph_02b = new monogram.component.CombinationGraphItem04Mobile({
    //'fill_color': '#bcc197'
  }, this.paper);
...
goog.inherits(monogram.component.CombinationGraph04Mobile, goog.events.EventTarget);
 ...
 * @const {object}
 */
monogram.component.CombinationGraph04Mobile.DEFAULT = {
  'option_01': '',
  'option_02': ''
};
 ...
 * @type {string}
 */
monogram.component.CombinationGraph04Mobile.EVENT_01 = '';
 ...
 * @type {string}
 */
monogram.component.CombinationGraph04Mobile.EVENT_02 = '';
...
monogram.component.CombinationGraph04Mobile.prototype.create_lines = function() {
  ...
  for (var i = 0, l=this.graph_angle_array.length; i < l; i++) {
    ...
    target_x = (Math.cos(graph_angle) * 227) + this.original_center_x;
    target_y = (Math.sin(graph_angle) * 227) + this.original_center_y;
...
monogram.component.CombinationGraph04Mobile.prototype.create_circles = function() {

  var circle_shape = null;

  for (var i = 0, l=10; i < l; i++) {
    circle_shape = this.paper.circle(this.original_center_x, this.original_center_y, (i+1) * 20 );
    circle_shape.attr({
      stroke: "#f1efee", 
      // opacity: 0.6, 
      opacity: 0.0, 
...
monogram.component.CombinationGraph04Mobile.prototype.reanimate_lines = function(){
...
monogram.component.CombinationGraph04Mobile.prototype.reanimate_circles = function(){
  var circle_shape = null;
...
monogram.component.CombinationGraph04Mobile.prototype.create_graph_01 = function() {
...
monogram.component.CombinationGraph04Mobile.prototype.create_graph_01_no = function(){
  this.graph_01.animate_out(0.1);
  this.graph_02.animate_out();
};

monogram.component.CombinationGraph04Mobile.prototype.create_graph_02 = function() {
...
monogram.component.CombinationGraph04Mobile.prototype.create_graph_02_no = function(){
...
monogram.component.CombinationGraph04Mobile.prototype.private_method_05 = function() {};
monogram.component.CombinationGraph04Mobile.prototype.private_method_06 = function() {};


/**
 * sample_method_calls
 */
monogram.component.CombinationGraph04Mobile.prototype.sample_method_calls = function() {
  monogram.component.CombinationGraph04Mobile.superClass_.method_02.call(this);                                    // call is important
  this.dispatchEvent(new goog.events.Event(monogram.component.CombinationGraph04Mobile.EVENT_01));
};
 ...
 */
monogram.component.CombinationGraph04Mobile.prototype.set_main_child_data = function(main_data_param, child_data_param) {
...
monogram.component.CombinationGraph04Mobile.prototype.hide_actual_01 = function() {
...
monogram.component.CombinationGraph04Mobile.prototype.create_actual_01 = function() {
...
monogram.component.CombinationGraph04Mobile.prototype.hide_actual_02 = function() {
...
monogram.component.CombinationGraph04Mobile.prototype.create_actual_02 = function() {
...
monogram.component.CombinationGraph04Mobile.prototype.hide_actual_01_main = function() {
  this.graph_01.animate_out(0.1);
};
monogram.component.CombinationGraph04Mobile.prototype.hide_actual_01_sub = function() {
  this.graph_02.animate_out();
};

monogram.component.CombinationGraph04Mobile.prototype.create_actual_01_main = function() {
  this.graph_01.set_score(this.main_data_item.score_array);
  this.graph_01.animate_in();
  this.graph_01.set_fill_color(this.main_data_item.data_color);
};
monogram.component.CombinationGraph04Mobile.prototype.create_actual_01_sub = function() {
  this.graph_02.set_score(this.sub_data_item.score_array);
  this.graph_02.animate_in(0.3);
  this.graph_02.set_fill_color(this.sub_data_item.data_color);
};
...
monogram.component.CombinationGraph04Mobile.prototype.hide_actual_02_main = function() {
  this.graph_01b.animate_out(0.1);
};
monogram.component.CombinationGraph04Mobile.prototype.hide_actual_02_sub = function() {
  this.graph_02b.animate_out();
};
monogram.component.CombinationGraph04Mobile.prototype.create_actual_02_main = function() {
  this.graph_01b.set_score(this.main_data_item.score_array);
  this.graph_01b.animate_in();
  this.graph_01b.set_fill_color(this.main_data_item.data_color);
};
monogram.component.CombinationGraph04Mobile.prototype.create_actual_02_sub = function() {
  this.graph_02b.set_score(this.sub_data_item.score_array);
  this.graph_02b.animate_in(0.3);
  this.graph_02b.set_fill_color(this.sub_data_item.data_color);
};
...
monogram.component.CombinationGraph04Mobile.prototype.instant_hide_actual_01_main = function() {
  console.log('instant_hide_actual_01_main');
  this.graph_01.instant_hide();
};
monogram.component.CombinationGraph04Mobile.prototype.instant_hide_actual_02_main = function() {
  console.log('instant_hide_actual_02_main');
  this.graph_01b.instant_hide();
};

monogram.component.CombinationGraph04Mobile.prototype.instant_show_actual_01_main = function() {
...
monogram.component.CombinationGraph04Mobile.prototype.instant_show_actual_02_main = function() {
...
monogram.component.CombinationGraph04Mobile.prototype.reanimate_actual_01_main = function(){
  this.graph_01.bounce();
};
monogram.component.CombinationGraph04Mobile.prototype.reanimate_actual_02_main = function(){
 ...
 * @param  {object} event
 */
monogram.component.CombinationGraph04Mobile.prototype.on_event_handler_01 = function(event) {
};
 ...
 * @param  {object} event
 */
monogram.component.CombinationGraph04Mobile.prototype.on_event_handler_02 = function(event) {
};
 ...
 * @param  {object} event
 */
monogram.component.CombinationGraph04Mobile.prototype.on_event_handler_03 = function(event) {
};
 ...
 * @param  {object} event
 */
monogram.component.CombinationGraph04Mobile.prototype.on_event_handler_04 = function(event) {
};
