...
monogram.page.Test = function(options, element) {
  ...
  this.options = $j.extend(this.options, monogram.page.Test.DEFAULT, options);
...
monogram.page.Test.prototype.init = function() {
  ...
  if ($j('#sample-single-graph').length != 0) {
    this.create_single_graph();
  }

  
  /*
  if ($j('#sample-combination-graph').length != 0) {
...
monogram.page.Test.prototype.create_single_graph = function(){
   ...
   */
  this.single_graph = new monogram.graph.SingleGraph({}, $j('#sample-single-graph'));
...
monogram.page.Test.prototype.create_combination_graph = function() {
   ...
   */
  this.combination_graph = new monogram.graph.CombinationGraph({}, $j('#sample-combination-graph'));


  this.combination_data_loader = new monograph.graph.CombinationDataLoader({}, $j('#monograph-combined-graph-data'));
