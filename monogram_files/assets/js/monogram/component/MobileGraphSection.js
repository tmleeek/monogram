...
monogram.component.MobileGraphSection = function(options, element) {
  ...
  this.options = $.extend({}, monogram.component.MobileGraphSection.DEFAULT, options);
  ...
  if (this.element.find('#tea-layering-graph-mobile').length != 0){
    ...
    TweenMax.to($('#tea-layering-graph-mobile #combination-graph-svg svg'), 0, {z:0.1});
  ...
  $('.page-tea-layering-detail-next-suggestion-btn').click(function(event){
    event.preventDefault();
    this.goto_next_sub();
  }.bind(this));

  $('#page-tea-layering-detail-next-arrow').click(function(event){
    this.goto_next_sub();
  }.bind(this));

  $('#page-tea-layering-detail-prev-arrow').click(function(event){
    this.goto_prev_sub();
  }.bind(this));
...
monogram.component.MobileGraphSection.prototype.display_combination_index = function(main_index_param, child_index_param) {
  ...
  if (goog.isDefAndNotNull(this.main_array[main_index_param]) &&
    ...
    if( (this.main_index + '' + this.sub_index) != (main_index_param + '' + child_index_param) ){
      ...
      $('#tea-layering-detail-copy-section .graph-selection-tea-mobile .graph-selection-title .number').html(b_num + ' / ' + b_total);
      ...
      $('#tea-layering-detail-copy-section').removeClass('animate-in');
...
monogram.component.MobileGraphSection.prototype.delayed_display_combination_index = function() {
  ...
  $('#tea-layering-detail-copy-section .graph-selection-tea-mobile #graph-selection-name-01 h2').html(name_01);
  $('#tea-layering-detail-copy-section .graph-selection-tea-mobile #graph-selection-name-02 h2').html(name_02);
  ...
  $('#tea-layering-detail-copy-section').addClass('animate-in');
