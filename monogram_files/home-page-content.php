<article id="home-intro-section" class="animated-section animate-in">
	<div class="content-container">	
		<div class="center-content">
			...
			<a href="javascript:void(0);"  id="home-intro-logo">
		...
		<div class="home-tea-item" data-id="milky-oolong">
			...
			<div class="home-tea-item-text">
				<h2>
					...
					<span style="color: #eccdce;">japonais</span>
				</h2>
				<h5>Green Tea</h5>
		...
		<div class="home-tea-item" data-id="milky-oolong">
			...
			<div class="home-tea-item-text">
				<h2>
					...
					<span style="color: #bdc8c4;">sencha</span>
				</h2>
				<h5>Green Tea</h5>
		...
		<div class="home-tea-item" data-id="milky-oolong">
			...
			<div class="home-tea-item-text">
				<h2>
					...
					<span style="color: #a3b1c8;">silk pearls</span>
				</h2>
				<h5>Green Tea</h5>
		...
		<div class="home-tea-item" data-id="milky-oolong">
			...
			<div class="home-tea-item-text">
				<h2>
					...
					<span style="color: #d8d2c4;">oolong</span>
				</h2>
				<h5>Oolong Tea</h5>
		...
		<div class="home-tea-item" data-id="earl-grey-neroli">
			...
			<div class="home-tea-item-text">
				<h2>
					...
					<span style="color: #c7b4e2;">florale<sup>tm</sup></span>
				</h2>
				<h5>Black Tea</h5>
		...
		<div class="home-tea-item" data-id="earl-grey-neroli">
			...
			<div class="home-tea-item-text">
				<h2>
					...
					<span style="color: #d8d1ca;">neroli</span>
				</h2>
				<h5>Black Tea</h5>
		...
		<div class="home-tea-item" data-id="earl-grey-neroli">
			...
			<div class="home-tea-item-text">
				<h2>
					...
					<span style="color: #fed298;">english<sup>tm</sup></span>
				</h2>
				<h5>Black Tea</h5>
		...
		<div class="home-tea-item" data-id="provencial-herbs">
			...
			<div class="home-tea-item-text">
				<h2>
					...
					<span style="color: #fd92a3;">of arianas<sup>tm</sup></span>
				</h2>
				<h5>Herbs</h5>
		...
		<div class="home-tea-item" data-id="provencial-herbs">
			...
			<div class="home-tea-item-text">
				<h2>
					...
					<span style="color: #bcc4b9;">mint</span>
				</h2>
				<h5>Herbs</h5>
