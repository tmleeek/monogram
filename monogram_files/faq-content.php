...
<article id="monogram-page-faq-title-section">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        <div id="monogram-page-faq-title">
          <h1>Monogram faq</h1>
        </div>
      </div>
    </div>
...
<article id="monogram-page-faq-content-section">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-2">
        ...
        <div id="monogram-page-faq-sidebar">
          <h4>category</h4>
          <ul>
        ...
        <div id="monogram-page-faq-content">
          ...
          <div id="monogram-page-faq-content-header" class="visible-md visible-sm">
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="monogram-page-faq-content-item-answer-header">
                  <h4>answer</h4>
                </div>
              </div>
            </div>
          </div> <!-- #monogram-page-faq-content-header -->
          ...
          <div class="monogram-page-faq-content-item-container first-version" data-value="health">

            <div class="monogram-page-faq-content-item">
              <div class="row">
                <div class="col-md-4">
                  <div class="monogram-page-faq-content-item-question">
                ...
                <div class="col-md-8">
                  <div class="monogram-page-faq-content-item-answer">
                    <div class="default-copy">
          ...
          </div> <!-- .monogram-page-faq-content-item-container -->
          ...
          <div class="monogram-page-faq-content-item-container" data-value="shopping">
          ...
          <div class="monogram-page-faq-content-item-container" data-value="tea">
          ...
          <div class="monogram-page-faq-content-item-container" data-value="account">
          ...
          <div class="monogram-page-faq-content-item-container" data-value="trade">
          ...
          <div id="monogram-page-faq-content-bottom"></div>
          
        </div> <!-- #monogram-page-faq-content -->
...
<script type="text/javascript">
  ...
  jQuery(document).ready(function($) {
    ...
    jQuery('body, html').addClass('monogram-page-faq');
      
    jQuery(window).on('hashchange', function(event){
      var hash = window.location.hash.replace('#', '');
      var item_container = [];
      if(hash != ''){
        item_container = jQuery(".monogram-page-faq-content-item-container[data-value=" + hash + "]");
      }


      if(hash != '' && item_container.length != 0){

        jQuery('.monogram-page-faq-content-item-container').removeClass('selected-version').stop(0).slideUp(500);
        item_container.addClass('selected-version').stop(0).slideDown(500);

      } else {
        // show first .monogram-page-faq-content-item-container
        
        jQuery('.monogram-page-faq-content-item-container').removeClass('selected-version').stop(0).slideUp(500);
        jQuery(jQuery('.monogram-page-faq-content-item-container')[0]).addClass('selected-version').stop(0).slideDown(500);
