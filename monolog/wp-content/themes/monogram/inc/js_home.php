<?php if(DEBUG): ?>
  ...
  <script type="text/javascript">
    goog.require('quest.page.Home');
  </script>
  <script type="text/javascript">
    page = new quest.page.Home({});
  </script>
...
<?php else: ?>
  ...
  <script type="text/javascript">
    <?php require_once('head.load.min.js'); ?>
  </script>

  <script type="text/javascript">
    var PAGE_LIBRARY        = "<?php echo THEMEROOT; ?>/assets/js/page-libraries.min.js";
    var PAGE_JS             = "<?php echo THEMEROOT; ?>/assets/js/page-home.min.js";
    ...
    window.custom_head.load(PAGE_LIBRARY, function() {
      window.custom_head.load(PAGE_JS, function() {
        window.page = new quest.page.Home({});
      });
    });
